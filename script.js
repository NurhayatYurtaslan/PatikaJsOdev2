...
const completedTaskList = document.querySelector(
  "#container-completed-task-list .task-list"
);
const containerCompletedTaskList = document.getElementById(
  "container-completed-task-list"
);
...
function getCompletedTasks() {
  if (
    localStorage.getItem("completedTasks") !== null &&
...
function searchTask(e) {
  ...
  let taskListItem = document.querySelectorAll(
    "#container-task-list .task-list .task"
  );
  let elementCount = 0;
...
function removeCompleteTask(e) {
  if (e.target.className === "icon icon-remove") {
    ...
    let nodeList = document.querySelectorAll(
      "#container-completed-task-list .task-list .task"
    ); //nodelistesi geri dönecek
    ...
    document
      .querySelectorAll(
        "#container-completed-task-list .task-list .task .task-text"
      )
      .forEach(function (element) {
        let nodeList = document.querySelectorAll(
          "#container-completed-task-list .task-list .task"
